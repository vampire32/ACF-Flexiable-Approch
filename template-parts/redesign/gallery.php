            ...
            <section class="video__gallery">
                ...
                <div class="swiper mySwiper video__gallery--slider">
                    <div class="swiper-wrapper">
                        <?php
                        // Fetch all 'video-gallery' posts
                        $args = array(
                            'post_type' => 'video-gallery',
                            'posts_per_page' => -1,
                        );
                        $video_galleries_query = new WP_Query($args);

                        if ($video_galleries_query->have_posts()) :
                            while ($video_galleries_query->have_posts()) : $video_galleries_query->the_post();
                                ?>
