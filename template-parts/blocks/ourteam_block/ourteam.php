                        ...
                        <div class="col-lg-6">
                            <div class="member">
                                <div class="member__image">
                                    <img width="2000" height="2000" src="<?php echo get_field('team_image',$post_id); ?>" class="attachment-full size-full wp-post-image" alt="" decoding="async" loading="lazy">
                                </div>
                                <h4 class="member__title"><?php echo get_field('team_name',$post_id); ?></h4>
                                <h5 class="member__designation"><?php echo get_field('team_designation',$post_id); ?></h5>
                            </div>
                        </div>
