                ...
                <?php $post_id = get_the_ID(); ?>
                    <div class="swiper-slide slide">
                        <div class="slide__thumbnail">
                            <a href="">
                                <iframe loading="lazy" width="100%" height="300px" src="<?php echo esc_url(get_field('video_slider', $post_id)); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </a>
                        </div>
                    </div>
